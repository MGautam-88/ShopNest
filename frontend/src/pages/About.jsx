...
const About = () => {
    ...
    return (
        <div style={containerStyle}>
            <img src="/images/dp.jpeg" alt="About Us" style={{ width: '180px', height: '180px', borderRadius: '50%', objectFit: 'cover', border: '4px solid #f97316', marginBottom: '20px', boxShadow: '0 4px 20px rgba(249, 115, 22, 0.4)' }} />

            <h2 style={{ fontSize: '2.5rem', marginBottom: '10px', color: '#fff' }}>About Me</h2>
            <h3 style={{ fontSize: '1.5rem', color: '#f97316', marginBottom: '15px' }}>Gautam Malhotra</h3>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '10px', marginTop: '20px' }}>
                ...
                <a href="" target="_blank" rel="noreferrer" style={{ ...socialBtnStyle, background: 'rgba(138, 72, 236, 0.2)', borderColor: '#793bf6', color: '#923bf6' }}>✖️ Twitter</a>
